...
const AddNewJob = () => {
    const { error, isLoading, message, addNewJob } = useGlobalJobContext();
        ...
        <div className="newJobcontainer">
            <div className="formWrapper">
                <div className="headerWrapper">
                    ...
                    <h1>
                        <i aria-hidden className="fas fa-copy mr-2"></i> POST A
                        JOB
                    </h1>
                </div>
                <form className="form" onSubmit={addNewJobHandler}>
                    <div className="row">
